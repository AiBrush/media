...
export class AacWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        AacWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aacwasm_free(ptr, 0);
    }
    /**
     ...
     */
    get channels() {
        const ret = wasm.aacwasm_channels(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    decode(data) {
        try {
            ...
            wasm.aacwasm_decode(retptr, this.__wbg_ptr, ptr0, len0);
     ...
     */
    constructor(extra_data, channels, sample_rate) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(extra_data, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.aacwasm_new(retptr, ptr0, len0, channels, sample_rate);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0;
            AacWasmFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    reset() {
        wasm.aacwasm_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    get sampleRate() {
        const ret = wasm.aacwasm_sampleRate(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) AacWasm.prototype[Symbol.dispose] = AacWasm.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./aac_wasm_bg.js": import0,
    };
}

const AacWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aacwasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('aac_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
