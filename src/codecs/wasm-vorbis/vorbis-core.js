/* @ts-self-types="./vorbis_wasm.d.ts" */
...
export class VorbisWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        VorbisWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vorbiswasm_free(ptr, 0);
    }
    /**
     ...
     */
    get channels() {
        const ret = wasm.vorbiswasm_channels(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    decode(data) {
        try {
            ...
            wasm.vorbiswasm_decode(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    constructor(extra_data, channels, sample_rate) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.vorbiswasm_new(retptr, ptr0, len0, channels, sample_rate);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0;
            VorbisWasmFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    reset() {
        wasm.vorbiswasm_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    get sampleRate() {
        const ret = wasm.vorbiswasm_sampleRate(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) VorbisWasm.prototype[Symbol.dispose] = VorbisWasm.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./vorbis_wasm_bg.js": import0,
    };
}

const VorbisWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vorbiswasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vorbis_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
