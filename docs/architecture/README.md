...
>
> **Not yet:** browser-harness `target:writes` instrumentation for true streamed-output scoring; software video encoders for AV1/VP8/VP9, MP3 encode approval, HEVC Main10 output, and true two-pass H.264; the 558-feature harness aggregate "win vs 7 engines" (the external acceptance gate). These are tracked as honest gaps, never claimed done.
