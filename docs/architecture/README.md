...
`[DECIDED]` locked · `[PROPOSED]` recommended default, not yet ratified · `[OPEN]` not yet decided. As of this writing the design is **fully decided** except one telemetry-deferred item (cost-aware tier thresholds).
