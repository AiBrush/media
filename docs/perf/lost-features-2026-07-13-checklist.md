...
| 21 | `probe/hls_aes128` | WON | PASS (fresh) | encrypted-HLS probe now classifies inherited keys and decrypts only the first segment through the existing RFC resolver; strict metadata golden passes | `results/raw/chromium-2026-07-13T14-23-16-097Z.json` (`n=5`, all 6 engine cells present; aibrush 23.235 ms vs Mediabunny 48.765 ms and FFmpeg 59.295 ms; 3 honest NA cells) | `aibrush-media@dev` winner; strict real AES-128 corpus + cleartext first-segment golden PASS |
...
| 29 | `remux/aac_adts_adts_to_mp4` | PASS, competitor winner | PASS (fresh; not winner) | performance; Mediabunny is faster on short ADTS-to-MP4 authoring | `results/raw/chromium-2026-07-13T13-26-01-810Z.json` (`n=5`, all 6 engine cells; aibrush 11.095 ms vs mediabunny 7.940 ms; strict output metadata/packet PASS) | — |
| 30 | `remux/av1_720p_5s_webm_to_mp4` | PASS, competitor winner | PASS (fresh; not winner) | performance; Mediabunny is faster on AV1 WebM-to-MP4 remux | `results/raw/chromium-2026-07-13T13-26-01-810Z.json` (`n=5`, all 6 engine cells; aibrush 11.320 ms vs mediabunny 10.380 ms; strict output packet PASS) | — |
| 31 | `remux/h264_1080p_5s_mov_to_mp4` | PASS, competitor winner | PASS (fresh; not winner) | performance; MP4Box is faster on MOV timing/edit-list remux | `results/raw/chromium-2026-07-13T13-26-01-810Z.json` (`n=5`, all 6 engine cells; aibrush 21.550 ms vs mp4box 15.165 ms; strict output packet PASS) | — |
| 32 | `remux/opus_ogg_to_webm` | PASS, competitor winner | WON (fresh) | performance; selective native Ogg-to-WebM routing wins the applicable competitors | `results/raw/chromium-2026-07-13T13-26-01-810Z.json` (`n=5`, all 6 engine cells; aibrush 4.800 ms vs fastest competitor 6.430 ms; strict output packet PASS) | `297895b` |
| 33 | `remux/vp9_1080p_10s_webm_to_mp4` | PASS, competitor winner | PASS (fresh; not winner) | performance; Mediabunny remains faster on long VP9 remux | `results/raw/chromium-2026-07-13T13-26-01-810Z.json` (`n=5`, all 6 engine cells; aibrush 45.715 ms vs mediabunny 22.810 ms; strict output packet PASS) | — |
...
| 36 | `transcode/h264_bitrate_2mbps` | FAIL | PASS (fresh; not winner) | correctness fixed by cadence-scaled H.264 ABR priming; performance remains behind stream-copy-like Remotion | `results/raw/chromium-2026-07-13T14-02-05-308Z.json` (`01.mp4`, aibrush 776.940 ms, SSIM 0.9890/0.9884), `...14-08-47-421Z.json` (`02.mp4`, 999.490 ms, SSIM 0.9709/0.9556), and `...14-11-46-525Z.json` (`03.mp4`, 2,856.940 ms, SSIM 0.9509/0.9435); all strict PASS; Remotion 53–69 ms but does not expose bitrate compliance | pending perf |
...
- The qualified post-fix exports currently mark the validated demux/probe/remux wins above; every row still
  requires the green commit and final full-suite rerun before close-out.
